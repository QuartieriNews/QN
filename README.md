...
| `autonomy/` | The deterministic lane gate: one pure function that classifies a pull request into GREEN / AMBER / RED and decides nothing else | Advisory until CI, separated identities and an atomic merge path are verified; the GREEN allowlist ships empty. Rules in `docs/autonomy/LANE_POLICY.md` (DEC-009, DEC-010). |
